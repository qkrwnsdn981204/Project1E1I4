...
public class BoardController {
    ...
    public String boardWriteOK(BoardDto boardDto) throws IOException {
    ...
    public String boardList(@AuthenticationPrincipal MyUserDetailsImpl myUserDetails,
        ...
        int newPage = boardDtoList.getNumber();
        int blockNum = 10;
        int startPage = (int) (
...
//                              @ModelAttribute BoardDto boardDto,
    ...
    public String noticeBoardWriteOK (BoardDto boardDto) throws IOException {
        boardService.boardInsertFile(boardDto);
